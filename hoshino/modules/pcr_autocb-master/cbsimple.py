...
@sv.on_fullmatch(('作业表', '作业', '预约', '预约表', '我想出刀'))
async def refs(bot, ev):
    msg = '''
公会战轴区作业网站
>>> https://www.caimogu.cc/gzlj.html
分刀器
>>> https://pcr.satroki.tech/'''
    await bot.send(ev, msg)
	
	
@sv.on_fullmatch(('sp', 'sp作业', '活动作业', '活动sp', '活动sp作业', '活动'))
async def refs(bot, ev):
    msg = '''【恩赐的财 团与神圣学院的问题儿童】
	公主连结：剧情活动「恩赐的财团与神圣学院的问题儿童」前瞻规划/作业参考 #丘比
	https://www.bilibili.com/read/cv15739994
	【公主连结】剧情活动「恩赐的财团 与神圣学院的问题儿童」前瞻规划&amp;考古作业 #NNS-nanashi
	https://www.bilibili.com/read/cv15706384
	【公主连结】恩赐的财团与神圣学院的问题儿童作业合集 #玩具猫
	https://www.bilibili.com/video/BV1QT4y1i7XC
	
	【兰德索尔之战 巨影复活】
	【公主连结】24小时限定活动「兰德索尔之战 巨影复活」活动前瞻 #NNS-naanshi
	https://www.bilibili.com/read/cv15742710'''
    await bot.send(ev, msg)
